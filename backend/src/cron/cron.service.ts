    ...
    for (const buyer of buyers) {
      ...
      if (!this.isProfileComplete(profile)) {
        ...
        const emailContent = `
          ...
          <p><a href="https://cim-amplify-five.vercel.app/resend-verification" style="background-color: #3aafa9; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block;">Resend Verification Email</a></p>
